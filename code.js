...
`;
// 来左边跟我一起画个名儿
const createName = (nodes, name) => __awaiter(this, void 0, void 0, function* () {
    // 画之前先要把字体加载好
...
// 齐活儿，开始整吧
const main = (msg) => __awaiter(this, void 0, void 0, function* () {
    const nodes = [];
    // 将接收到的颜色转化为 RGB 格式
    ...
    // 画名儿
    const text = yield createName(nodes, name);
    // 根据名儿的宽度调整矩形宽度
